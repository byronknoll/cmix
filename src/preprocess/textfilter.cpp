...
#define CHAR_FIRSTUPPER 64
#define CHAR_UPPERWORD 7
#define CHAR_LOWERWORD 6
#define CHAR_PUNCTUATION 8
#define CHAR_NOSPACE 8
#define CHAR_CR_LF 14
#define CHAR_ESCAPE 12
#define NGRAM_FIRST 'A'
#define NGRAM_LAST 'Z'
#define BINARY_FIRST 128
#define BINARY_LAST 255

#define AUTO_SWITCH 8
...
void WRT_start_decoding(FILE* file,FILE* fileout,int header,FILE* english_dictionary)
{
 ...
 preprocType=(EPreprocessType)(c%4);
 ...
 if (IF_OPTION(OPTION_USE_DICTIONARY))
 {
  ...
  i=longDictLen+1+shortDictLen+1+(IF_OPTION(OPTION_USE_DICTIONARY)?1:0);
 }
 else
 {
  longDictLen=0;
